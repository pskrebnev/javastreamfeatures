...
//        voidMethodWithTwoParams();
    ...
    private static void voidMethodWithNoParams() {
        VoidMethodWithNoParams method = () -> System.out.println("Method with no return and input params");
    ...
    private static void voidMethodWithTwoParams() {
        VoidMethodWithTwoParams addition = (a, b) -> System.out.println("Sum: " + Math.addExact(a, b));

        VoidMethodWithTwoParams multiplication = (a, b) -> System.out.println("Multiple: " + Math.multiplyExact(a, b));
    ...
    private static void returnMethodWithTwoParams() {
        ReturnMethodWithTwoParams addition = Integer::sum;
